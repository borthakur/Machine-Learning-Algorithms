...
test_dataset = ImageDataset(data_csv = test_data, train=False, img_transform=img_transforms) ######### Make train=False ################
...
class convolutional(nn.Module):
  def __init__(self):
    ...
    self.CONV3 = nn.Conv2d(in_channels=64,out_channels=512,kernel_size=(3,3),stride=1)
    self.BN3 = nn.BatchNorm2d(512)
    self.POOL3 = nn.MaxPool2d(2,2)
    self.CONV4 = nn.Conv2d(in_channels=512,out_channels=1024,kernel_size=(2,2),stride=1)
